...
<%@include file="../includes/header.jsp" %>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">게시판 </h4>
              ...
              <div class="demo-inline-spacing">
                ...
                <h5 class="card-header">가게홍보게시판&nbsp;&nbsp;&nbsp;&nbsp;<button id="regBtn" type="button" class="btn btn-sm btn-primary">내 가게 홍보하기</button></h5>
